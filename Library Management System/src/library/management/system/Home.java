...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
	    ...
	    super("My Library");
            ...
            menuBar.setBackground(new Color(97, 137, 47));
            ...
            mntmLogout.setBackground(new Color(34, 38, 41));
            ...
            mntmExit.setBackground(new Color(34, 38, 41));
            ...
            mntmReadme.setBackground(new Color(34, 38, 41));
            mntmReadme.setForeground(Color.WHITE);
            mnHelp.add(mntmReadme);

            JMenuItem mntmAboutUs = new JMenuItem("About Us");
            mntmAboutUs.setForeground(Color.WHITE);
            mntmAboutUs.setBackground(new Color(34, 38, 41));
            ...
            bookdetails.setBackground(new Color(34, 38, 41));
            bookdetails.setForeground(Color.WHITE);
            mnRecord.add(bookdetails);

            JMenuItem studentdetails = new JMenuItem("Student Details");
            studentdetails.setBackground(new Color(34, 38, 41));
            ...
            panel.setBorder(new TitledBorder(new LineBorder(new Color(97, 137, 47), 1), "Add Books and Students", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(97, 137, 47)));
            ...
            b5.setBackground(new Color(97, 137, 47));
            ...
            b6.setBackground(new Color(97, 137, 47));
            ...
            panel2.setBorder(new TitledBorder(new LineBorder(new Color(97, 137, 47), 1), "Issue and Return", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(97, 137, 47)));
