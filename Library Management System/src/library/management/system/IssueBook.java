...
public class IssueBook extends JFrame implements ActionListener{
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(97, 137, 47), 1, true), "Student-Deatails",
    ...
    public void actionPerformed(ActionEvent ae){
		...
		rs.close();
            ...
            if(ae.getSource() == b3){
                    try{
                String sql2 = "select * from issuebook where book_id = ? and student_id = ?";
